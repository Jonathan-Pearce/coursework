...
y = [0.0131;0.0542;0.1652; 0.5614;1.6412; 2.9546; 4.9099; 8.3626; 10.9059; 15.4361];
...
legend({'Timing Data',' Normal Equations Least Squares Solution'},'Location','northwest')
